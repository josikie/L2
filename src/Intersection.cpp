...
void WaitingVehicles::permitEntryToFirstInQueue()
{
    ...
    auto Begin_Vehicle = _vehicles.begin();
    std::promise<void> Begin_Promises = std::move(_promises.front());
    Begin_Promises.set_value();
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::promise<void> prmsVehicle; 
    std::future<void> ftrVehicle = prmsVehicle.get_future();
    _waitingVehicles.pushBack(vehicle, std::move(prmsVehicle));
